## <a name="operations-admin-revenue-reports"></a> Revenue reports
...
```shell
curl -X GET \
"https://api.mpc.placewise.com/v1/operations/stores/3/revenue_reports?tax_category_ids=2,3&start_date=2021-01-02&end_date=2021-01-03" \
  -H 'authorization: Bearer eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICIyOE' \
  -H 'content-type: application/json' \
  -H 'x-loyalty-club-slug: infinity-mall' \
  -H 'x-user-agent: CURL manual test'
...
**GET** `v1/operations/stores/:store_id/revenue_reports`
